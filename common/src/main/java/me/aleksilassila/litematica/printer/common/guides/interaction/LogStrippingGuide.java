package me.aleksilassila.litematica.printer.common.guides.interaction;
...
import me.aleksilassila.litematica.printer.common.mixin.AxeItemAccessor;
...
public class LogStrippingGuide extends InteractionGuide {
    ...
    public boolean canExecute(ClientPlayerEntity player) {
        if (!LitematicaMod.STRIP_LOGS.getBooleanValue()) return false;
